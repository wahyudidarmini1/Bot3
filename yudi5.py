...
acil = PRANKBOTS.LINE() 
acil.login(token="ErPOUD2ZsudAUOeNKdn2.AZs3a8Vf+ipnhLTOmQbtuG.z7aERkHNm0lzd12vtvyArlnVuUppMtGDy54r9LWhlNU=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="ErQS0QFIG8Nk1q2is1jc.6mZHYoaLrB6ZemDONQ/Mha.633Gg15t8V1KeJ593nxiSqmPOl5WQDpqap2IELgUP30=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="ErZH0FqlXLXup9szxVp2.SOI7MV+GPU//ng7dyQOwmG.oFTEWafd+Ec21ujVSLPAnQDTO4zl6r+2LDBqH8wAa/Y=")
pb2.loginResult()

pb3 = PRANKBOTS.LINE() 
pb3.login(token="ErMULLuwxS1dWLCQYZoe.4uWnRTJU51yT+/CjXTyHBG.guziOKyKwMExq5aNy59YVAb3cF+GDeTehTxccXPam/Q=")
pb3.loginResult()

pb4 = PRANKBOTS.LINE() 
pb4.login(token="ErsyfMMhqa90owCPDac3.eXGEKA8y87MQtoFvPFGwuW.HctCPDxEwZSXYEXwG6XrG6+LdEfTdgknrKy/M/037XQ=")
pb4.loginResult()
